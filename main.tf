...
module "aws-networking" {
  ...
  file-placement-groups                  = "${path.module}/parameters/placement-groups.json"
  file-vpn-customer-gateways             = "${path.module}/parameters/vpn-customer-gateways.json"
  file-vpn-virtual-private-gateways      = "${path.module}/parameters/vpn-virtual-private-gateways.json"
}
