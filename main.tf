...
module "aws-networking" {
  source = "../terraform-aws-core-networking"
  ...
  //file-r53-public-hosted-zones  = "${local.path.networking}/r53-public-hosted-zones.json"
  //file-r53-private-hosted-zones = "${local.path.networking}/r53-private-hosted-zones.json"
  file-r53-cidr-collections = "${local.path.networking}/r53-cidr-collections.json"
  file-r53-cidr-locations   = "${local.path.networking}/r53-cidr-locations.json"
}


/*Security Stack..
module "aws-security" {
  source = "../terraform-aws-core-security"
  ...
  //file-r53-dns-firewall-domain-lists = "${local.path.security}/r53-dns-firewall-domain-lists.json"
  //file-r53-dns-firewall-rules        = "${local.path.security}/r53-dns-firewall-rules.json"
  //file-r53-dns-firewall-rule-groups  = "${local.path.security}/r53-dns-firewall-rule-groups.json"
}*/
